package com.sengpgroup.sengp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sengpgroup.sengp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sengpgroup.sengp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
